	...
	*/
	this.addPayRecipient = function (opts) {
		return new Promise(function (resolve, reject) {
			...
			dispatch.sendRequest(reqBody, baseUrl + routes.add_pay_recipients_endpoint, opts.accessToken)
				.then((response) => {
	...
	*/
	this.sendPay = function (opts) {
		return new Promise(function (resolve, reject) {
			...
			dispatch.sendRequest(reqBody, baseUrl + routes.send_payments_endpoint, opts.accessToken)
				.then((response) => {
					resolve(response.headers['location'])
				})
				.catch((error) => {
